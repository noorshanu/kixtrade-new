          ...
          <div className="bg-sec">
            <div class="w-full mx-auto table-1">
              <div>
                ...
                The total Trade-athon 1,000,000 $KiX Prize is divided into two pools:
                </p>

                <ul className=" ml-5 	">
                  <li className="	list-disc py-4 text-[#FFC200] text-3xl " >
                    <p className="text-base sm:text-[22px] text-white	">
                    900,000 $KiX Trading Prize Pool - awarded according to the total winnings and profit each competitor makes from playing the KiX Test Platform.
                    </p>
                  </li>
                  <li className="list-disc  py-4 text-[#FFC200] text-3xl">
                    <p className="text-base sm:text-[22px] text-white ">
                    100,000 $KiX Zealy Quest Prize Pool - awarded according to the total XP generated by each competitor who choses to take on tasks on the KiX Zealy platform.
                    </p>
                  </li>
                </ul>

                <p className="text-base sm:text-[22px] font-normal  my-4 pr-2">
                Competitors can enter the KiX Trade-athon at any time, and stop playing at any time too, and any gains made on either the KiX Test platform OR the KiX Zealy platform will be taken into consideration, in keeping with the Trade-athon competition rules, at the conclusion of this promotion.
                </p>
              </div>
              {/* <table class="w-full">
                <tbody>
