  ...
  return (
    <section className=" text-center mt-8 sm:mt-8">
      <div>
        ...
        Qualified entrants who connect their digital-wallet to the KiX Test platform will be able to
        claim 1,000 FreeKiX points and then play for a share of 1,000,000 $KiX 
          <br /> in the KiX game.
        </p>
